...
function partial_scan!(op::Function, output::CuDeviceArray{T}, input::CuDeviceArray,
                      aggregates::Union{Nothing, CuDeviceArray{T}}, Rdim, Rpre, 
...
function scan!(f::Function, output::CuArray{T}, input::CuArray{T2};
    ...
    #partial_scan!(op::Function, output::CuDeviceArray{T}, input::CuDeviceArray,
    #Rdim, Rpre, Rpost, Rother, neutral::T, init,
    #::Val{inclusive}=Val(true), ::Val{shuffle}=Val(true))
